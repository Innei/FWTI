...
export const personalities: Record<string, Personality> = {
  ...
  VOID: {
    ...
    wasteLevel: 4,
    description:
      '恭喜你触发了隐藏人格——你不是不懂爱，你只是对社交代谢率极低。微信置顶永远是外卖小哥，交友软件装过三次卸过三次，每次装完第一件事是关提醒。亲戚催婚你只会干笑，回家躺平发两小时朋友圈（仅自己可见）。你对"断联"的感觉不是焦虑，是轻松——TA 一上线你就心悸，TA 两天不找你你反而能活过来。你不是冷漠，你只是把"不回消息"当作一种正当的生活方式。',
    traits: [
  ...
  LIMBO: {
    ...
    wasteLevel: 4,
    description:
      '恭喜你触发了隐藏人格——你对心里藏着的那位 TA 的社交媒体时间轴倒背如流，TA 的关注列表你心里有谱，TA 上周吃了什么餐厅你能画出地图。TA 本人？你们没说过几句话。你不是在追求 TA，你是在研究 TA——为一段从未真正存在的关系做了三年博士后。你心里明白应该放下，但又总觉得"再等一等说不定 TA 就回头了"，于是在"等"字上停了三年。你的废不在于爱得太深，而在于把一段单向迷恋保存在玻璃罩里，永远 limbo。',
    traits: [
