...
export const resultPageCopy = {
  ...
  attachmentEyebrow: '依恋粗分 · Attachment',
  attachmentTitle: '粗略依恋倾向',
  attachmentAxisAttachment: '黏附 A',
  attachmentAxisSecurity: '安全 S',
  attachmentDisclaimer: '仅由 A / S 两维粗略估计，非正式 ECR-R 量表结论。',
